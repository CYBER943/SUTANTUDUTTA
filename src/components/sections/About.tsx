        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative bg-app-card border border-app-border p-8 rounded-[2rem] overflow-hidden hover:border-[#3B82F6] hover:shadow-[0_0_30px_rgba(59,130,246,0.2)] transition-all duration-300 block"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-white/0 via-[#3B82F6]/5 to-white/0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
              <div className="flex justify-between items-start mb-12 relative z-10">
                <div className="w-12 h-12 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="relative z-10">
                <h4 className="text-xl font-medium tracking-tight text-white mb-1 group-hover:text-[#3B82F6] transition-colors">CodePen</h4>
            ...
            >
              ...
              <div className="relative z-10">
                <h4 className="text-xl font-medium tracking-tight text-white mb-1 group-hover:text-[#3B82F6] transition-colors">GitHub</h4>
