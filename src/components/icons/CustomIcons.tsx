...
export const GrokIcon = ({ size = 24, ...props }: React.SVGProps<SVGSVGElement> & { size?: number | string }) => (
  <svg viewBox="0 0 88 33" fill="currentColor" width={size} height={size} {...props}>
    <path d="M76.4462 24.7077V8.41584H79.0216V19.1679L84.4685 12.9109H87.5908L82.6908 18.2731L87.6364 24.7077H84.5596L80.5539 19.1788L79.0216 19.1679V24.7077H76.4462Z" />
    ...
    <path d="M55.5659 24.7077V14.782L57.731 12.9109H62.3347V15.1014H58.1413V24.7077H55.5659Z" />
...
export const NoteGPTIcon = (props: React.SVGProps<SVGSVGElement> & { size?: number | string }) => {
...
export const DevinIcon = ({ size = 24, ...props }: React.SVGProps<SVGSVGElement> & { size?: number | string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size} {...props}>
    <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" />
  </svg>
);

export const B12Icon = ({ size = 24, ...props }: React.SVGProps<SVGSVGElement> & { size?: number | string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size} {...props}>
    <path d="M6 3h7a5 5 0 0 1 5 5c0 1.9-1.1 3.5-2.7 4.3C17.3 13 18.5 14.8 18.5 17a5 5 0 0 1-5 5H6V3zm3 3v5h4a2.5 2.5 0 0 0 0-5H9zm0 8v5h4.5a2.5 2.5 0 0 0 0-5H9z" />
  </svg>
);

export const GoogleAIStudioIcon = ({ size = 24, ...props }: React.SVGProps<SVGSVGElement> & { size?: number | string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size} {...props}>
    <path d="M12 2L2 22h20L12 2zm0 3.8l6.2 14.2H5.8L12 5.8z" />
  </svg>
);

export const WindsurfIcon = ({ size = 24, ...props }: React.SVGProps<SVGSVGElement> & { size?: number | string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width={size} height={size} {...props}>
